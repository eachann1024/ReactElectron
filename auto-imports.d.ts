...
declare global {
  ...
  const use: typeof import('./src/store/useHome')['use']
  const useAntdTable: typeof import('ahooks')['useAntdTable']
  const useAppStore: typeof import('./src/store/useApp')['useAppStore']
  ...
  const useClipboardStore: typeof import('./src/store/useClipboard')['useClipboardStore']
  ...
  const useHomeStore: typeof import('./src/store/useClipboard')['useHomeStore']
